...
return [
    ...
    */
    ...
    'custom' => [
        'postal_code' => [
            'postalcode' => 'Pole :attribute powinno być w formacie XX-XXX.',
        ],
        'lat' => [
            'coordinate' => 'Pole :attribute powinno być w formacie XX.XXXX.',
        ],
        'lng' => [
            'coordinate' => 'Pole :attribute powinno być w formacie XX.XXXX.',
        ],
        'telephone' => [
            'telephone' => 'Pole :attribute powinno być w formacie XXX-XXX-XXX.',
        ],
    ],
